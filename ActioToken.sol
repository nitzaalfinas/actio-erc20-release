...
contract ActioToken is Context, Ownable, IERC20, IERC20Metadata
{
    ...
    string private _name = "Actio96"; // testnet
    //string private _name = "Actio";  

    string private _symbol = "AIO96"; // testnet
    ...
    mapping(address => bool) public _excludedTrfFee;
    ...
    function changeExcludeTrfFee (address input_) public onlyOwner { 
        _excludedTrfFee[input_] = !_excludedTrfFee[input_]; 
    }
    ...
    constructor() {
        ...
        _excludedTrfFee[owner()] = true;
        _excludedTrfFee[address(this)] = true;
        _excludedTrfFee[DEAD] = true;
    ...
    function _transferTax(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (sender == _pair) { 
            ...
            if (!_excludedTrfFee[sender] || !_excludedTrfFee[recipient]) {
